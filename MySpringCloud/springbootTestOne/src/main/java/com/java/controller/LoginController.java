...
//	 "query")
	...
	public ResponseData login(String name,String email) {
		System.out.println("收到getUser请求，参数："+name+"======"+email);
		...
		data.getData().put("user", PageHelper.startPage(1, 1).doSelectPageInfo(() -> userMapper.selectAll()));
