...
public class ArithUtil {
	...
	/**
	* @Description: 提供精确的加法运算,默认四舍五入保留2位小数
	* @param @param v1
	* @param @param v2
	* @param @return    设定文件 
	* @return float    返回类型 
	* @throws
	...
	/**
	* @Description: 精确的减法运算,默认四舍五入保留2位小数
	* @param @param v1
	* @param @param v2
	* @param @return    设定文件 
	* @return float    返回类型 
	* @throws
	...
	/**
	* @Description: 精确的乘法运算,默认四舍五入保留2位小数
	* @param @param v1
	* @param @param v2
	* @param @return    设定文件 
	* @return float    返回类型 
	* @throws
	...
	/**
	 * @description: 提供（相对）精确的除法运算，当发生除不尽的情况时，精确到 小数点以后2位，以后的数字四舍五入。
	 * @param v1 被除数
	 * @param v2  除数
	 * @return 两个参数的商
	 */
	...
	/**
	* @Description: 精确的除法运算,默认四舍五入保留2位小数
	* @param @param v1
	* @param @param v2
	* @param @return    设定文件 
	* @return float    返回类型 
