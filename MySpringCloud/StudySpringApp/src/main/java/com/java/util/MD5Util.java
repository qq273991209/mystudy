 ...
 * @Title: MD5Util.java
 * @Package com.java.util
 * @Description: TODO(MD5盐值加密工具类)
 * @author 刘云升
 * @date 2019年5月29日 下午5:39:05 Copyright (c) ©1994-2019 Scjydz.com All Rights
 *       Reserved.
 */
public class MD5Util {
	...
	public static void main(String[] args) {
		...
		System.out.println("md5(123456vip)=" + md.digest("123456vip"));
	}
