...
// * File Name:TestHisUpdateInfo.java
// * Package Name:com.java.controller
// * Date:2019年6月24日下午5:44:53
...
//
///**   
// * @Title: TestHisUpdateInfo.java 
// * @Package com.java.controller 
// * @Description: TODO(用一句话描述该文件做什么) 
// * @author 刘云升  
// * @date 2019年6月24日 下午5:44:53 
// * Copyright (c) ©1994-2019 Scjydz.com All Rights Reserved.
// */
//@RestController
//public class TestHisUpdateInfo {
//	@Autowired
...
//	@RequestMapping("TestHisUpdateInfo")
//	public String TestHisUpdateInfo() {
//		// 调用His接口查询所有网上体检套餐集合
//
//		// 假数据测试========================
